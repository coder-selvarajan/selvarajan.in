...
const Home = () => {
  return (
    <main className="max-w-[1024px] mx-auto px-4">
      <section className="py-8 md:py-20 flex flex-col md:flex-row items-center gap-12">
        {/* Hero Content */}
        <div className="w-full md:w-3/5 space-y-6 pl-4 md:pr-8">
          ...
          <div className="pt-6 flex gap-5 pb-10">
            <a
            ...
            <a
              href="https://www.youtube.com/@alchemyofcode"
              target="_blank" 
              className="inline-flex items-center gap-2 bg-gray-300 px-5 py-3 rounded-lg hover:text-orange-600 transition-colors"
            >
        ...
        {/* Hero Image */}
        <div className="w-full md:w-2/5 md:align-bottom ">
          <div className="relative w-full max-w-[350px] mb-8 mx-auto">
            <img 
              src="/images/me.png"
              alt="Developer Color" 
      ...
      <section className="py-12">
        <h2 className="text-4xl font-quicksand font-bold text-center mb-12">Apps</h2>
      ...
      {/* My Talks Section */}
      <section className="py-12">
        <h2 className="text-4xl font-quicksand font-bold text-center mb-8">Talks</h2>
        <div className="bg-gray-200 rounded-2xl shadow-lg overflow-hidden max-w-[1024px] mx-auto p-6 md:p-10">
          <div className="flex flex-col md:flex-row items-center gap-8">
            ...
            <div className="w-full md:w-1/2">
              <div className="relative pb-[56%] h-0">
                <iframe
                  ...
                  src="https://www.youtube.com/embed/EDakjMVUlSk"
                  title="SwiftUI Animations Session"
                  frameBorder="0"
            ...
            <div className="w-full md:w-1/2 text-center md:text-left">
              <p className="text-lg text-gray-600 mb-6">
                Feeling incredibly grateful to have delivered my first-ever online session on SwiftUI animations with such an inspiring iOS Developer community! 🙌 
                <br/><br/>
                It’s amazing to see how SwiftUI continues to open up endless possibilities for creating delightful user experiences. 🚀 
              </p>
              <a
                href="https://www.youtube.com/watch?v=EDakjMVUlSk"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 rounded-lg  hover:text-orange-600 transition-shadow"
              >
      ...
      <section className="py-4 md:py-16">
        <h2 className="text-4xl font-quicksand font-bold mb-4 text-center">Recent Artworks</h2>
