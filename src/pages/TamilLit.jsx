      ...
      <main className="max-w-[1024px] mx-auto px-4">
        <div className="min-h-screen bg-gray-100 text-gray-900">
          ...
          <section className="pt-12 pb-16 flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 text-left space-y-8 pl-4">
          ...
          <section className="pt-16 pb-5 bg-gray-200 rounded-3xl px-4 md:px-8 shadow-sm">
            <h2 className="text-4xl font-semibold text-center mb-16">10 Renowned Literature Books</h2>
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-6 mb-12 px-2 md:px-0">
              {[
                ...
                <div key={book.en} className="py-1 px-2 md:px-2 rounded-xl text-center">
                  <img 
                    src={`/images/icons/${book.en.toLowerCase()}.png`}
                    alt={book.en}
                    className="w-full bg-gray-50 rounded-2xl shadow-md mb-3 md:mb-5 p-3 md:p-6"
                  />
          ...
          <section className="pt-20 mb-20">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              ...
              <div className="space-y-12">
                <div>
                  <div className="bg-gray-200 rounded-3xl shadow-lg px-8 md:px-6 pt-10">
              ...
              <div>
                  <div className="bg-gray-200 rounded-3xl shadow-lg px-8 md:px-6 pt-10">
                    <div className="text-center mb-6">
                    <h3 className="text-2xl font-bold">Intuitive Category</h3>
          ...
          <section className="pb-20 space-y-16">
            ...
            <div className="bg-gray-200 rounded-3xl px-10 md:px-20 pt-10 shadow-sm">
              <div className="flex flex-col-reverse md:flex-row items-center gap-16">
                ...
                <div className="md:w-2/3 space-y-4">
                  <h3 className="text-3xl font-bold">Random Pick</h3>
            ...
            <div className="bg-gray-200 rounded-3xl px-10 md:px-24 pb-10 shadow-sm">
              <div className="flex flex-col-reverse md:flex-row items-center gap-5">
                <div className="md:w-2/3 space-y-4">
                  <h3 className="text-3xl font-bold">Daily Inspiration</h3>
                  <p className="text-gray-600 text-lg">
          ...
          <h3 className="text-4xl text-center font-bold">Themes</h3>
            ...
            <div className="bg-gray-200 rounded-3xl px-8 md:px-20 py-12 shadow-sm">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <img 
                    src="/images/tamillit/themes-mobile.png" 
                    alt="Theme Options" 
          ...
          <section className="pb-12 space-y-8">
          <h2 className="text-4xl font-semibold text-center mb-10">Accessibility-Driven Experience </h2>
